...
class SelectCommandTest < Minitest::Test
  ...
  def test_execute_replaces_repository_when_user_selects_yes
    informations = [
      ManagedLectureRoomInformation.new(room_name: "第10講義室"),
      ManagedLectureRoomInformation.new(room_name: "第11講義室")
    ]
    parser = Object.new
  ...
  def test_execute_does_not_replace_repository_when_user_selects_no
    information = ManagedLectureRoomInformation.new(room_name: "第10講義室")
    parser = Object.new
